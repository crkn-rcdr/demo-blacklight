...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'subject_tsim', label: 'Subject'
    config.add_facet_field 'format', label: 'Format'
    config.add_facet_field 'author_tsim', label: 'Author'
    config.add_facet_field 'language_ssim', label: 'Language'
    config.add_facet_field 'pub_date_si', label: 'Published'
    config.add_facet_field 'subject_geo_ssim', label: 'Region'
    config.add_facet_field 'title_series_tsim', label: 'Series'
